---
name: Neovim interaction skill
description: This skill should be used when the user asks to "configure neovim", "manage plugins", "build custom nvim releases", "reload nvim config", or "interact with nvimd".
version: 1.0.0
---
