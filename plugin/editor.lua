...
if ok_snacks then
  ...
  vim.keymap.set("n", "<leader>gf", function() snacks.lazygit.log_file() end, { desc = "Lazygit Log File" })
  ...
  vim.keymap.set("n", "<leader>lD", function() snacks.picker.diagnostics_buffer() end, { desc = "LSP Buffer Diagnostics" })
end
...
if ok_yanky then
  ...
  if snacks then
    vim.keymap.set("n", "<leader>p", function() snacks.picker.yanky() end, { desc = "Yank History" })
  end
end
